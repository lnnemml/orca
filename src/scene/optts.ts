...
export function buildOptTSInput(
  ...
  // 4. Emit via the existing builder. Method + solvation are carried as `!`-line keywords (composite
  //    slot, verbatim); jobType = `OptTS Freq`; TightSCF. The Scan/opt keyword of the source cannot
