...
- [x] **C2a — reaction/pathway management UI.** `ReactionsScreen.tsx` (new "Reactions" tab): create a
      ...
      `tsc` 0, `vitest` 638 (+6), `vite build` clean, `cargo` 207 (Job column additive). **Manual gate
